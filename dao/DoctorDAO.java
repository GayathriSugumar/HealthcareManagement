...
public class DoctorDAO {
	 ...
	 * System.out.println("Invoked ChangePassword()"); boolean flag = false;
	 * 
	 * try { String sqlStatement =
	 * "select * from doctor where email=? and password=?";
	 * 
	 * PreparedStatement prepareStatement =
	 * connection.prepareStatement(sqlStatement); prepareStatement.setString(1,
	 * email); prepareStatement.setString(2, oldPassword);
	 * 
	 * ResultSet result = prepareStatement.executeQuery(); while (result.next()) {
	 * flag = true; }
	 * System.out.println("Password has been change Successfully!..");
	 * 
	 * } catch (Exception e) { e.printStackTrace();
	 * System.out.println("Password has not been change!.."); } return flag; }
	 */
...
//
//		try {
//			String sqlStatement = "update doctor set password=? where email=?";
//
//			PreparedStatement prepareStatement = connection.prepareStatement(sqlStatement);
...
//				flag = true;
//			}
//			System.out.println("Password has been updated "+newPassword+email);
//		} catch (Exception e) {
//			e.printStackTrace();
